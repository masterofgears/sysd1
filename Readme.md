...
Реализует [ADR 02](adr/adr-02.md)
...
Реализует [ADR 04](adr/adr-04.md)
...
[ADR 01: Apache Airflow](adr/adr-01.md)

[ADR 02: Debezium и Kafka Connect](adr/adr-02.md)

[ADR 03: Kafka](adr/adr-03.md)

[ADR 04: Запрос схемы БД из Источника](adr/adr-04.md)
